...
<div id="characterComponents" class="hide">
    ...
    <table>
        <tr class="character-reward-row">
            ...
            @if ($expanded_rewards)
                <td>
                    {!! Form::select('character_rewardable_type[]', ['Item' => 'Item', 'Currency' => 'Currency', 'Award' => 'Award'] + (isset($showLootTables) && $showLootTables ? ['LootTable' => 'Loot Table'] : []), null, [
                ...
                <td class="lootDivs">
                    ...
                    <div class="character-awards hide">{!! Form::select('character_award_id[]', $characterAwards, 0, ['class' => 'form-control character-award-id', 'placeholder' => 'Select Award']) !!}</div>
