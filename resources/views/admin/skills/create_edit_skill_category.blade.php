...
@section('admin-content')
    ...
    @if ($category->id)
        ...
        <div class="card mb-3">
            <div class="card-body">
                @include('world._item_category_entry', ['imageUrl' => $category->categoryImageUrl, 'name' => $category->displayName, 'description' => $category->description, 'category' => $category, 'visible' => $category->is_visible])
            </div>
        </div>
    @endif
@endsection
