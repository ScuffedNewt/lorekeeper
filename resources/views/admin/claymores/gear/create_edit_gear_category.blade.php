...
@section('admin-content')
    {!! breadcrumbs([
        'Admin Panel' => 'admin',
        'Gear Categories' => 'admin/gear/gear-categories',
        ($category->id ? 'Edit' : 'Create') . ' Category' => $category->id ? 'admin/gear/gear-categories/edit/' . $category->id : 'admin/gear/gear-categories/create',
    ]) !!}
