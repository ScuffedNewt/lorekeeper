...
@section('admin-content')
    ...
    <div class="text-right mb-3">
        ...
        <a class="btn btn-primary" href="{{ url('admin/weapons/create') }}"><i class="fas fa-plus"></i> Create New Weapon</a>
    </div>
            ...
            @foreach ($weapons as $weapon)
                <div class="d-flex row flex-wrap col-12 mt-1 pt-2 px-0 ubt-top">
                    ...
                    <div class="col-3 col-md-1 text-right">
                        <a href="{{ url('admin/weapons/edit/' . $weapon->id) }}" class="btn btn-primary py-0 px-2">Edit</a>
                    </div>
                </div>
            @endforeach
        </div>
