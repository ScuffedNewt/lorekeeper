...
@section('admin-content')
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::select(
                    ...
                    $season->start_month,
                    ['class' => 'form-control', 'placeholder' => 'Select Start Month'],
                ) !!}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::select(
                    ...
                    $season->end_month,
                    ['class' => 'form-control', 'placeholder' => 'Select End Month'],
                ) !!}
            </div>
        </div>
    </div>
    ...
    <p>These are the potential weathers from rolling on this season.@if (!$season->id)
            You can test rolling after the season is created.
        @endif
    </p>
