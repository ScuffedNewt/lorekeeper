    ...
    **********************************************************************************************/
    ...
    public function createPrompt($data, $user) {
        ...
        try {
            ...
            $prompt = Prompt::create(Arr::only($data, ['prompt_category_id', 'name', 'summary', 'description', 'parsed_description', 'is_active', 'start_at', 'end_at', 'hide_before_start', 'hide_after_end', 'has_image', 'prefix', 'hide_submissions', 'staff_only', 'form_field']));
    ...
    public function updatePrompt($prompt, $data, $user) {
        ...
        try {
            ...
            $prompt->update(Arr::only($data, ['prompt_category_id', 'name', 'summary', 'description', 'parsed_description', 'is_active', 'start_at', 'end_at', 'hide_before_start', 'hide_after_end', 'has_image', 'prefix', 'hide_submissions', 'staff_only', 'form_field']));
