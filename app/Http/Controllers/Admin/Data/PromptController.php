...
class PromptController extends Controller {
    ...
    **********************************************************************************************/
    ...
    public function postCreateEditPrompt(Request $request, PromptService $service, $id = null) {
        ...
        $data = $request->only([
            'name', 'prompt_category_id', 'summary', 'description', 'start_at', 'end_at', 'hide_before_start', 'hide_after_end', 'is_active', 'rewardable_type', 'rewardable_id', 'quantity', 'image', 'remove_image', 'prefix', 'hide_submissions', 'staff_only', 'form_field',
        ]);
