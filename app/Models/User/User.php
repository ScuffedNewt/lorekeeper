...
class User extends Authenticatable implements MustVerifyEmail {
    ...
    public function characters() {
        // get both user_id and coowner_id characters
        return $this->hasMany(Character::class)->where('is_myo_slot', 0)->orderBy('sort', 'DESC')->union(
            $this->hasMany(Character::class, 'coowner_id')->where('is_myo_slot', 0)->orderBy('sort', 'DESC')
        );
    }
